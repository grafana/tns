...
switch $argv
	...
	case run
		weave run --with-dns --hostname=db.weave.local peterbourgon/tns-db
		weave run --with-dns --hostname=db.weave.local peterbourgon/tns-db
		weave run --with-dns --hostname=app.weave.local peterbourgon/tns-app
		weave run --with-dns --hostname=app.weave.local peterbourgon/tns-app
		weave run --with-dns --hostname=lb.weave.local peterbourgon/tns-lb
		weave run --with-dns --hostname=lb.weave.local peterbourgon/tns-lb
